---
description: "Complete coding standards: linting, formatting, and code quality rules"
argument-hint: ""
---
...
⚠️ **ALWAYS run `pnpm lint` from the root of the monorepo after making code changes**
⚠️ **Ensure there are 0 linting issues before completing any task**
⚠️ **NEVER run build commands (`pnpm build`, `pnpm web:build`, etc.) unless explicitly asked by the user**
⚠️ **NEVER run dev server commands (`pnpm dev`, `next dev`, etc.) unless explicitly asked by the user**
...
1. Run `pnpm lint` from the project root
2. Fix any linting errors
3. Ensure 0 issues before marking task complete
4. Run `pnpm format` if needed for consistency
...
Use this comprehensive reference whenever working with code to maintain project quality standards.